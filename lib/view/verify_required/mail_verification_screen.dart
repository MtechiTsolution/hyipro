...
class MailVerificationScreen extends StatefulWidget {
  static const String routeName = "/mail_verification_screen";
              ...
              right: 24,
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        "${selectedLanguageStorage.read("languageData")["Email Verification"] ?? "Email Verification"}",
                      ...
                      TextFormField(
                        ...
                        controller: verifyRequiredController.mailVerifyCodeController,
                        ...
                        child: GestureDetector(
                          onTap: (){
                            if (isResendEnabled) {
                              ...
                              Get.find<ResendCodeController>().getResendCode("email").then((value){
                                startResendTimer();
                              });
                            }
                          },
                     ...
                     if (_formKey.currentState!.validate()) {
                       verifyRequiredController.mailVerifySubmit(
                           verifyRequiredController.mailVerifyCodeController.text.toString()
                       );
                        }
                        },
                        child: Container(
                          ...
                          child: Center(
                              child:
                              verifyRequiredController.isLoadingMail==false?
                              Text(
