  ...
  Widget build(BuildContext context) {
    return GetBuilder<ReferralBonusController>(
      ...
      return RefreshIndicator(
        onRefresh: ()async{
          Get.find<ReferralBonusController>().getReferralBonusSearchData("", "",page: 1);
        },
        child: Scaffold(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            SizedBox(height: 5.h,),
                                            TextFormField(
                                              controller: Get.find<ReferralBonusController>().name,
                                              decoration: InputDecoration(
                                                  ...
                                                  hintText: "${selectedLanguageStorage.read("languageData")["Search User"]??"Search User"}",
                                            ...
                                            TextFormField(
                                              ...
                                              controller: TextEditingController(text: Get.find<ReferralBonusController>().selectedDate.value),
                                              decoration:  InputDecoration(
                                            ...
                                            InkWell(
                                              onTap: () {
                                                  ...
                                                  Navigator.pop(context);
                                                  Get.find<ReferralBonusController>().referralBonusItems.clear();
                                                  Get.find<ReferralBonusController>().getReferralBonusSearchData(
                                                    Get.find<ReferralBonusController>().name.text.toString(),
                                                    Get.find<ReferralBonusController>().selectedDate.value,
                                                  );
          ...
          body: ListView(
            children: [
              ...
              GetBuilder<ReferralBonusController>(
                builder: (referralBonusController) {
                  final historyItems = referralBonusController.referralBonusItems;
