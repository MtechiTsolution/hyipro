    ...
    return GetBuilder<ReferralController>(
      ...
      return RefreshIndicator(
        ...
        child: Scaffold(
            ...
            body: referralController.isLoading == false && referralController.message != null
                ?
            ListView(
              children: [
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color:
                              Get.isDarkMode? AppColors.appContainerBgColor:
                              ...
                              children: [
                                ...
                                Expanded(
                                    child: GestureDetector(
                                      onTap: (){
                                        Clipboard.setData(ClipboardData(text: "${referralController.message!.referralLink}"));
                                        ScaffoldMessenger.of(context).showSnackBar(
                                          const SnackBar(
                                            backgroundColor: AppColors.appDashBoardTransactionGreen,
                                              content: Text('Text copied to clipboard',style: TextStyle(
                                                  color: Colors.white
                                              ),)),
                                        );
                                      },
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                      ...
                      itemCount: referralController.message!.referrals!.length,
                      shrinkWrap: true,
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        boxShadow: [
                                          BoxShadow(
                                            color: Get.isDarkMode? AppColors.appPrimaryColor.withOpacity(0.1) : AppColors.appPrimaryColor.withOpacity(0.1),
                                        ...
                                        border: Border.all(
                                          color: selectedIndex!=index  ? AppColors.appPrimaryColor : AppColors.appPrimaryColor,
                                        ),
                                        color: selectedIndex!=index ? AppColors.appWhiteColor : AppColors.appPrimaryColor,
                                        borderRadius: BorderRadius.circular(5)
                                    ),
                                    child: Center(child: Text("${selectedLanguageStorage.read("languageData")["Level"]??"Level"} ${index+1}",
                                      style: GoogleFonts.niramit(
                ...
                referralController.isLoading == false && referralController.message != null
                    ? referralController.message!.referrals!["1"]!.isEmpty
                    ? Center(
                  child: Center(
                    child: Column(
                    ...
                    itemBuilder: (context, referralIndex) {
                      return Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: ListView.builder(
                            shrinkWrap: true,
                            itemCount: referralController.message!.referrals!["${referralIndex+1}"]!.length,
                            itemBuilder: (context,index){
                              return Padding(
                                                ...
                                                child: Center(
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text("${selectedLanguageStorage.read("languageData")["Level"]??"Level"}",  style: GoogleFonts.publicSans(
                                                            fontSize: 12.sp,
                                                  ...
                                                  children: [
                                                    Padding(
                                                      ...
                                                      child: Row(
                                                        ...
                                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                        children: [
                                                          Text("${referralController.message!.referrals!["${referralIndex+1}"]![index].email}",
                                                            style: GoogleFonts.niramit(
                                                                fontWeight: FontWeight.w500,
                                                                fontSize: 16.sp,
                                                                color: AppColors.getTextDarkLight()
                                                          ...
                                                          Text("${selectedLanguageStorage.read("languageData")["Joined At"]??"Joined At"}",
                                                            style: GoogleFonts.niramit(
                                                                fontWeight: FontWeight.w500,
                                                                fontSize: 16.sp,
                                                                color: AppColors.appBlackColor50
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Row(
                                                        ...
                                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                        children: [
                                                          Text("${referralController.message!.referrals!["${referralIndex+1}"]![index].username}",
                                                            style: GoogleFonts.niramit(
                                                                fontWeight: FontWeight.w500,
                                                                fontSize: 16.sp,
                                                                color: AppColors.appBlackColor50
                                                          ...
                                                          Text("${formatApiDate(referralController.message!.referrals!["${referralIndex+1}"]![index].createdAt.toString())}",
                                                            style: GoogleFonts.niramit(
                                                                fontWeight: FontWeight.w500,
                                                                fontSize: 14.sp,
                                                                color: AppColors.getTextDarkLight()
