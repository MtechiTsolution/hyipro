...
class _TransactionHistoryScreenState extends State<TransactionHistoryScreen> {
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      onRefresh: () async{
        Get.find<TransactionHistoryController>().getTransactionHistorySearchData("", "", "",page: 1);
      },
      child: Scaffold(
        backgroundColor: AppColors.getBackgroundDarkLight(),
                                            ...
                                            child: Column(
                                              children: [
                                                ...
                                                Column(
                                                  children: [
                                                    TextFormField(
                                                      controller: Get.find<TransactionHistoryController>().transactionId,
                                                      decoration: InputDecoration(
                                                          ...
                                                          hintText: "${selectedLanguageStorage.read("languageData")["Search for Transaction ID"]??"Search for Transaction ID"}",
                                                          hintStyle: TextStyle(
                                                    ...
                                                    TextFormField(
                                                      controller: Get.find<TransactionHistoryController>().remark,
                                                      decoration: InputDecoration(
                                                          contentPadding: EdgeInsets.symmetric(
                                                              horizontal: 10.r, vertical: 5.r),
                                                          filled: true,
                                                          fillColor: AppColors.getTextFieldDarkLight(),
                                                          border: InputBorder.none,
                                                          hintText: "${selectedLanguageStorage.read("languageData")["Remark"]??"Remark"}",
                                                          hintStyle: TextStyle(
                                                              fontSize: 14.sp, fontWeight: FontWeight.w400,
                                                              color: AppColors.appBlackColor50)),
                                                    ),
                                                    ...
                                                    TextFormField(
                                                      ...
                                                      controller: TextEditingController(text: Get.find<TransactionHistoryController>().selectedDate.value),
                                                      decoration:  InputDecoration(
                                                        ...
                                                        suffixIcon:GestureDetector(
                                                            onTap: (){
                                                              transactionHistoryController.setDate("");
                                                            },
                                                            child:  transactionHistoryController.selectedDate.isNotEmpty ?
                                                            Padding(
                                                              padding:  EdgeInsets.all(16.0.h),
                                                              child: Text("${selectedLanguageStorage.read("languageData")["Clear"]??"Clear"}",
                                                                style: TextStyle(
                                                    ...
                                                    InkWell(
                                                      onTap: (){
                                                        Navigator.pop(context);
                                                        Get.find<TransactionHistoryController>().transactionHistorySearchItems.clear();
                                                        Get.find<TransactionHistoryController>().getTransactionHistorySearchData(
                                                          Get.find<TransactionHistoryController>().transactionId.text.toString(),
                                                          Get.find<TransactionHistoryController>().remark.text.toString(),
                                                          Get.find<TransactionHistoryController>().selectedDate.value.toString(),
                                                        );
                                                      },
                                                      child: Container(
                                                        height: 45.h,
          ...
          body:
          ListView(
            controller: Get.find<TransactionHistoryController>().scrollController,
            shrinkWrap: true,
            children: [
              ...
              GetBuilder<TransactionHistoryController>(
                builder: (transactionHistoryController) {
                  final historyItems =
                      transactionHistoryController.transactionHistorySearchItems;
                  ...
                  if (transactionHistoryController.isLoading==true &&
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        if (index < transactionHistoryController.transactionHistorySearchItems.length) {
                                      ...
                                      Expanded(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Text("${item.remarks}",style: GoogleFonts.nunito(
                                                    color: AppColors.getTextDarkLight(),
                                                    fontSize: 15.sp,fontWeight: FontWeight.bold)
                                                ),
                                                SizedBox(height: 6.h,),
                                                Text("${item.time}",style: GoogleFonts.nunito(
                                                    color: AppColors.appBlackColor50,
                                                    fontSize: 12.sp),),
                                              ],
                                            ),
                                          )),
                                      Text("${item.amount} ${item.currency}",style:   GoogleFonts.nunito(
                                          color: item.color=="danger" ?
                                          AppColors.appDashBoardTransactionRed : AppColors.appDashBoardTransactionGreen,
                                          fontSize: 15.sp,fontWeight: FontWeight.bold)),
