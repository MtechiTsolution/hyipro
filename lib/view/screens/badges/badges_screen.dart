                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color:
                              badgesController.message![index].isCurrentRank!=true?
                              Get.isDarkMode? AppColors.appContainerBgColor:
                              AppColors.appFillColor:AppColors.appPrimaryColor,
                            ),
                            child: Padding(
                              padding: EdgeInsets.only(
                                top: 20.h,
                                ...
                                children: [
                                  ...
                                  Positioned(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Image.network("${badgesController.message![index].rankIcon}",height: 60.h,width: 60.w,),
                                        Text("${badgesController.message![index].rankLavel}",
                                    ...
                                    children: [
                                      Text(
                                        ...
                                        style: GoogleFonts.niramit(
                                          ...
                                          color:
                                          badgesController.message![index].isCurrentRank!=true?
                                          AppColors.getTextDarkLight():AppColors.appWhiteColor,
                                          fontWeight: FontWeight.w600,
                                        ),
                                      ),
                                        ...
                                        children: [
                                          Text(
                                            ...
                                            style: GoogleFonts.niramit(
                                              ...
                                              color:
                                              badgesController.message![index].isCurrentRank!=true?
                                              AppColors.appBlackColor50:AppColors.appWhiteColor,
