...
import 'package:hyip_pro/data/model/response_model/app_steps_model.dart';
...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<AppStepsController>(
      builder: (appStepsController) {
        return Scaffold(
          backgroundColor: AppColors.getBackgroundDarkLight(),
          body:
          appStepsController.isLoading==false?
          Stack(
            children: <Widget>[
              PageView.builder(
