        ...
        return Scaffold(
          ...
          body: SingleChildScrollView(
            child: Container(
              ...
              height: MediaQuery.of(context).size.height * 0.9, // Set the height to half of the screen
                  ...
                  Expanded(
                    child: notificationController.logList.isEmpty
                      ...
                      child: Column(
                        ...
                        children: [
                          Get.isDarkMode?
                          Image.asset("assets/images/dark_no_notification.png",
                            height: 250.h,
                            width: 250.w,
                          ):
                          ...
                          Text("No Notifications Yet",style: GoogleFonts.niramit(
                            fontSize: 20.sp,
                            color: AppColors.getTextDarkLight(),
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Dismissible(
                          ...
                          onDismissed: (direction) {
                            ...
                            notificationController.logList.removeAt(index);
                            GetStorage().write(
                                '${Get.find<PusherConfigController>().message!.channel}', notificationController.logList.toList());
                          },
                          child: ListTile(
                            title: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      ...
                                      Padding(
                                        ...
                                        child: Image.asset("assets/images/notification_icon_new.png",
