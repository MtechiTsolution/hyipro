                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                              ...
                              filled: true,
                              hintText: "${selectedLanguageStorage.read("languageData")["Receiver Email Address"]??"Receiver Email Address"}",
                        ...
                        Obx(() => AppCustomDropDown(
                          ...
                          selectedValue: transferScreenController.selectedOption.value,
                          hint: 'Select an option',
                          decoration: BoxDecoration( // Customize the button's decoration
                            borderRadius: BorderRadius.circular(5),
                            color:
                            AppColors.getTextFieldDarkLight()
                          ),
                          dropdownDecoration: BoxDecoration( // Customize the dropdown's decoration
                            color:
                        ...
                        TextFormField(
                          obscureText: !transferScreenController.isPasswordVisible.value,
                          ...
                          decoration: InputDecoration(
                              suffixIcon: GestureDetector(
                                onTap: () {
                                  transferScreenController.togglePasswordVisibility();
                                },
                                child: Icon(
                              ...
                              fillColor: AppColors.getTextFieldDarkLight(),
                              filled: true,
                              hintText: "${selectedLanguageStorage.read("languageData")["Enter Password"]??"Enter Password"}",
                              hintStyle: GoogleFonts.niramit(
                                  fontWeight: FontWeight.w400,
                                  fontSize: 16.sp,
                                  color: AppColors.appBlackColor30)),
                        ...
                        InkWell(
                          onTap: () {
                            if (_formKey.currentState!.validate()) {
                              transferScreenController.sendBalanceTransferRequest(
                                      transferScreenController.emailCtrl.text.toString(),
                                      transferScreenController.amountCtrl.text.toString(),
                                      transferScreenController.selectedOption.value ==
                                              "Main Balance"
                                          ? "balance"
                                          : "interest_balance",
                                      transferScreenController.passwordCtrl.text.toString(),context);
                            }
                          },
                          child: Container(
                            height: 52.h,
