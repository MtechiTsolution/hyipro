  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      account.getAccountData().then((value) {
        account.firstName.text = "${Get.find<MyAccountController>().message!.userFirstName??""}";
        account.lastName.text = "${Get.find<MyAccountController>().message!.userLastName??""}";
        account.userName.text = "${Get.find<MyAccountController>().message!.username??""}";
        account.address.text = "${Get.find<MyAccountController>().message!.userAddress??""}";
        account.phone.text = "${Get.find<MyAccountController>().message!.userPhone??""}";
        account.email.text = "${Get.find<MyAccountController>().message!.userEmail??""}";
      });
    });
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Center(
                              child: Text("${selectedLanguageStorage.read("languageData")["Upload Profile Image"]??"Upload Profile Image"}",style: GoogleFonts.niramit(
                                                        ...
                                                        GestureDetector(
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: Column(
                                                              mainAxisAlignment: MainAxisAlignment.center,
                                                              children: [
                                                                Icon(Icons.camera,size: 35.h,color: AppColors.appBlackColor50,),
                                                                SizedBox(height: 2.h,),
                          ...
                          GestureDetector(
                            onTap: (){
                              myAccountController.updateAccountImage(pickedImage!.path).then((value) {
                            ...
                            child: Center(
                              child: Container(
                                ...
                                child: Center(
                                    child: myAccountController.isLoadingImage==false ? Text(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Center(
                            child: Text("${selectedLanguageStorage.read("languageData")["Upload Profile Information"]??"Upload Profile Information"}",
                          ...
                          //
                          // Text("${selectedLanguageStorage.read("languageData")["Firstname"]??"Firstname"}",
                          //     style: GoogleFonts.niramit(
                          //         fontSize: 16.sp,
                          //         color: AppColors.getTextDarkLight(),
                          //         fontWeight: FontWeight.w500
                          ...
                          //     hintText: "${selectedLanguageStorage.read("languageData")["firstname"]??"firstname"}",
                          ...
                          // Text("${selectedLanguageStorage.read("languageData")["Lastname"]??"Lastname"}",
                          //     style: GoogleFonts.niramit(
                          //         fontSize: 16.sp,
                          //         color: AppColors.getTextDarkLight(),
                          //         fontWeight: FontWeight.w500
                        ...
                        /*  SizedBox(height: 8.h,),
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              hintText: "${selectedLanguageStorage.read("languageData")["lastname"]??"lastname"}",
                              hintStyle: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w400,
                                  color: AppColors.appBlackColor50),
                              contentPadding: EdgeInsets.only(
                                  left: 12, top: 10, bottom: 12),
                          ...
                          SizedBox(height: 16.h,),
                          Text("${selectedLanguageStorage.read("languageData")["Email"]??"Email"}",
                              style: GoogleFonts.niramit(
                                  fontSize: 16.sp,
                                  color: AppColors.getTextDarkLight(),
                                  fontWeight: FontWeight.w500
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              hintText: "${selectedLanguageStorage.read("languageData")["Email"]??"Email"}",
                              hintStyle: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w400,
                                  color: AppColors.appBlackColor50
                              ),
                              contentPadding: EdgeInsets.only(
                          ...
                          Text("${selectedLanguageStorage.read("languageData")["Phone"]??"Phone"}",
                              style: GoogleFonts.niramit(
                                  fontSize: 16.sp,
                                  color: AppColors.getTextDarkLight(),
                                  fontWeight: FontWeight.w500
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              hintText: "${selectedLanguageStorage.read("languageData")["address"]??"address"}",
                              hintStyle: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w400,
                                  color: AppColors.appBlackColor50),
                              contentPadding: EdgeInsets.only(
                                  left: 12, top: 10, bottom: 12),
                          ...
                          Text("${selectedLanguageStorage.read("languageData")["Username"]??"Username"}",
                              style: GoogleFonts.niramit(
                                  fontSize: 16.sp,
                                  color: AppColors.getTextDarkLight(),
                                  fontWeight: FontWeight.w500
                          ...
                          SizedBox(height: 16.h,),
                          Text("${selectedLanguageStorage.read("languageData")["Address"]??"Address"}",
                              style: GoogleFonts.niramit(
                                  fontSize: 16.sp,
                                  color: AppColors.getTextDarkLight(),
                                  fontWeight: FontWeight.w500
                          ...
                          GestureDetector(
                            onTap: (){
                              myAccountController.updateAccountInformation(
                            ...
                            child: Center(
                              child: Container(
                                ...
                                child: Center(
                                    child: myAccountController.isLoadingInformation==false ? Text(
