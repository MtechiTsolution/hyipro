            ...
            backgroundColor: AppColors.getBackgroundDarkLight(),
              ...
              ListView(
                children: [
                  ...
                  myAccountController.message!.userIdentityVerifyFromShow==true?
                  Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text("${selectedLanguageStorage.read("languageData")["Select Identity Type"]??"Select Identity Type"}",
                          style: GoogleFonts.publicSans(
                          ...
                          child: Column(
                            children: [
                              ListView.builder(
                                  ...
                                  shrinkWrap: true,
                                  itemCount: myAccountController.message!.identityFormList!.length,
                                  itemBuilder: (context,index){
                                    return  buildRadioButton(myAccountController.message!.identityFormList![index].id,
                                        myAccountController.message!.identityFormList![index].name);
                                  })
                            ],
                          ),
                        ),
                      ...
                      GetBuilder<MyAccountController>(
                        builder: (myAccountController) {
                          if (myAccountController.isLoading) {
                            return SizedBox();
                          } else if (myAccountController.message != null) {
                            return SingleChildScrollView(
                              padding: const EdgeInsets.all(16),
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: myAccountController.formFields, // Use the list of form fields here
                              ),
                            );
                          } else {
                            return Center(child: Text("${selectedLanguageStorage.read("languageData")["No data available."]??"No data available."}"));
                          }
                        },
                      ),
                      ...
                      selectedOption != 0
                          ...
                          builder: (myAccountController) {
                            return GestureDetector(
                              onTap: (){
                                if(myAccountController.fieldNames!=null && myAccountController.fieldValues!=null && myAccountController.selectedFilePath!=null){
                                  Get.find<VerificationController>().sendIdentityVerificationRequest(
                                      selectedType(selectedIdentityType),
                                      myAccountController.fieldNames,
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child:
                                  Get.find<VerificationController>().isIdentityLoading==false?
                                  Center(
                                      child: Get.find<VerificationController>().isLoading==false ? Text(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Text("${myAccountController.message!.userIdentityVerifyMsg}",
                                    style:
      ...
      trailing: Radio<int>(
        ...
        onChanged: (int? newValue) {
          setState(() {
            ...
            Get.find<MyAccountController>().getAccountData(identityFormName:text);
          });
        },
      ),
    );
