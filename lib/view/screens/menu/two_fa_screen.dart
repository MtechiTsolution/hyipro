...
class TwoFaScreen extends StatelessWidget {
            ...
            children: [
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      Image.asset("assets/images/two_fa_image.png",
                      height: 148.h,
                        width: 148.w,
                      ),
                      ...
                      QrImageView(
                        foregroundColor:Get.isDarkMode? AppColors.appWhiteColor: AppColors.appBlackColor,
                        data: '${twoFaSecurityController.message!.qrCodeUrl}',
                      ...
                      AppCustomButton(
                        ...
                        onTap: () {
                          ...
                          Get.defaultDialog(
                            ...
                            title: "${selectedLanguageStorage.read("languageData")["2 Step Security"]??"2 Step Security"}",
                            content: Padding(
                              padding: const EdgeInsets.symmetric(
                            ...
                            confirm: ElevatedButton(
                              style: ElevatedButton.styleFrom(
                                  backgroundColor: AppColors.appPrimaryColor // Customize the button color
                              ),
                              onPressed: () {
                                twoFaSecurityController
                          ...
                          Get.defaultDialog(
                            ...
                            titlePadding:
                            EdgeInsets.only(top: 10.h),
                            title: "${selectedLanguageStorage.read("2 Step Security")["2 Step Security"]??"2 Step Security"}",
                            content: Padding(
                              padding: const EdgeInsets.symmetric(
                                  horizontal: 10, vertical: 16),
                              child: Column(
                      ...
                      Center(
                        child: Padding(
                          ...
                          child: AppCustomButton(
                            titleColor: AppColors.appWhiteColor,
                            title: "${selectedLanguageStorage.read("languageData")["Download App"]??"Download App"}",
                            height: 50.h,
                            borderRadius: 32.00,
                            width: double.infinity,
                            onTap: (){
  ...
  Future<void> launchPlayStore() async {
    final url = 'https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2&hl=en&gl=US';
