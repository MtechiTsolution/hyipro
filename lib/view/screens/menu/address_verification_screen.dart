                ...
                GetBuilder<MyAccountController>(
                    builder: (myAccountController) {
                      ...
                      Padding(
                        ...
                        child: myAccountController.message!.userAddressVerifyFromShow==true?
                        Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text("${selectedLanguageStorage.read("languageData")["Address Proof"]??"Address Proof"}",style: TextStyle(
                                    fontSize: 14.sp
                                ),),
                            ...
                            GestureDetector(
                              onTap: (){
                                if(pickedImage!=null){
                                  verificationController.sendAddressVerificationRequest(
                                      pickedImage.path
                                  ).then((value) {
                                    pickedImage=null;
                              ...
                              child: Container(
                                ...
                                child:
                                verificationController.isLoading==false?
                                Center(
                                    child: verificationController.isLoading==false ? Text(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Text("${myAccountController.message!.userAddressVerifyMsg}",
                                          style:
                                          GoogleFonts.publicSans(
                                              fontSize: 17.sp,
                                              color: AppColors.getTextDarkLight(),
