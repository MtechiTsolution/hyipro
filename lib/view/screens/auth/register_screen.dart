...
//                           fillColor: AppColors.getTextFieldDarkLight(),
//                           filled: true,
//                           hintText: "${selectedLanguageStorage.read("languageData")["First Name"]??"First Name"}",
//                           prefixIcon: Padding(
//                             padding: const EdgeInsets.all(16.0),
//                             child: Image.asset(
...
//                           fillColor: AppColors.getTextFieldDarkLight(),
//                           filled: true,
//                           hintText: "${selectedLanguageStorage.read("languageData")["Last Name"]??"Last Name"}",
//                           prefixIcon: Padding(
//                             padding: const EdgeInsets.all(16.0),
//                             child: Image.asset(
//                                 "assets/images/fname_lname_img.png",
...
//                           fillColor: AppColors.getTextFieldDarkLight(),
//                           filled: true,
//                           hintText: "${selectedLanguageStorage.read("languageData")["Email Address"]??"Email Address"}",
//                           prefixIcon: Padding(
//                             padding: const EdgeInsets.all(16.0),
...
//                               dialogBackgroundColor: AppColors.appWhiteColor,
