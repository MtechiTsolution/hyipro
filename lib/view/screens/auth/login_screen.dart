...
import 'package:hyip_pro/view/screens/auth/forget_password.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void retrieveSavedCredentials() async {
    ...
    setState(() {
      Get.find<AuthController>().loginUserNameTxt.text = prefs.getString('username') ?? '';
      Get.find<AuthController>().loginUserNameTxt.text = prefs.getString('password') ?? '';
  ...
  void saveCredentials() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setString('username', Get.find<AuthController>().loginUserNameTxt.text);
    prefs.setString('password', Get.find<AuthController>().loginPasswordTxt.text);
  }
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                              ...
                              filled: true,
                              hintText: "${selectedLanguageStorage.read("languageData")["Username or Email"]??"Username or Email"}",
                              prefixIcon: Padding(
                        ...
                        Row(
                          children: [
                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                      color: AppColors.appBlackColor30, // Border color when unchecked
                                      width: 1,
                                    ),
                                    color: isRemember ?
                            ...
                            Text("${selectedLanguageStorage.read("languageData")["Remember Me"]??"Remember Me"}",
                                style: GoogleFonts.niramit(
                                    color: AppColors.appBlackColor30,
                                    fontWeight: FontWeight.w400,
                                    fontSize: 16.sp)),
                            ...
                            TextButton(
                              ...
                              child: Text("${selectedLanguageStorage.read("languageData")["Forgot Your Password?"]??"Forgot Your Password?"}",
                                  style: GoogleFonts.niramit(
