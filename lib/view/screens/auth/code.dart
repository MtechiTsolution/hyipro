          ...
          children: [
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text("${selectedLanguageStorage.read("languageData")["Enter your OTP code"]??"Enter your OTP code"}",
                    style: TextStyle(
                        fontSize: 20.sp,
                        fontFamily: 'Dubai',
                  ...
                  Text("${selectedLanguageStorage.read("languageData")["Enter the 5 digits code that you received on your email"]??"Enter the 5 digits code that you received on your email"}",
                    style: TextStyle(
                        fontSize: 16.sp,
                        fontFamily: 'Dubai',
                      ...
                      child: Row(
                        children: [
                          ...
                          isResendEnabled
                            ...
                            style: GoogleFonts.publicSans(
                              fontSize: 14.sp,
                              color: AppColors.appDashBoardTransactionPending,
                              decoration: TextDecoration.underline,
                            ),
                          )
                              : Text(" Resend in ${timerDuration}s",
                            style: GoogleFonts.publicSans(
                              fontSize: 14.sp,
                              color: AppColors.appBlackColor,
                            ),
