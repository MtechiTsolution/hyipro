            ...
            builder: (investHistoryController) {
              ...
              if (investHistoryController.isLoading == true &&
                ...
                return ListView.builder(
                  ...
                  controller: Get.find<InvestHistoryController>().scrollController,
                  shrinkWrap: true,
                  ...
                  itemBuilder: (context, index) {
                    if (index < investHistoryController.historyItems.length) {
                      ...
                      return Padding(
                        padding:
                            EdgeInsets.only(left: 24.w, right: 24.w, bottom: 16),
                        child: Column(
                          children: [
                            Container(
                                  ...
                                  children: [
                                      ...
                                      children: [
                                        Text(
                                          ...
                                          style: GoogleFonts.niramit(
                                              ...
                                              color:
                                              Get.isDarkMode? AppColors.appWhiteColor:
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          item.nextPaymentDate!=null && item.nextPaymentDate !="null"?
                                    ...
                                    LinearPercentIndicator(
                                     ...
                                     width: 350.w,
                                      lineHeight: 12.h,
                                      // percent: double.parse(item.percentPayment.toString()),
                                      percent:
                                      item.percentPayment!=null?
