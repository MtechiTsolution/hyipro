...
import 'package:hyip_pro/view/screens/bottomnavbar/bottom_navbar.dart';
...
class _PayoutHistoryScreenState extends State<PayoutHistoryScreen> {
  ...
  void initState() {
    ...
    Get.find<PayoutHistoryController>().getPayoutHistorySearchData("", "", "",page: 1);
    super.initState();
  }
            ...
            return Scaffold(
              ...
              appBar: AppBar(
                                              ...
                                              child: Padding(
                                                ...
                                                child: Column(
                                                  children: [
                                                    ...
                                                    SizedBox(height: 5.h,),
                                                    TextFormField(
                                                      controller: Get.find<PayoutHistoryController>().name,
                                                      ...
                                                      child: Obx(
                                                          ...
                                                          decoration: BoxDecoration(
                                                            ...
                                                            borderRadius: BorderRadius
                                                                .circular(8.0),
                                                           color: Get.isDarkMode? AppColors.appContainerBgColor:
                                                            AppColors.appFillColor,
                                                          ),
                                                          dropdownDecoration: BoxDecoration(
                                                            borderRadius: BorderRadius
                                                                .circular(8.0),
                                                            color:
                                                            Get.isDarkMode? AppColors.appDefaultDarkMode:
                                                            Colors.white,
                                                          ),
                                                          itemHeight: 40, // Set the height of each item in the dropdown
                                                        ),
                                                      ),
                                                    ),
                                                    ...
                                                    TextFormField(
                                                      ...
                                                      controller: TextEditingController(text: Get.find<PayoutHistoryController>().selectedDate.value),
                                                      decoration:  InputDecoration(
                                                              ...
                                                              child: Text("${selectedLanguageStorage.read("languageData")["Clear"]??"Clear"}",
                                                                style: TextStyle(
                                                                  fontWeight: FontWeight
                                                                      .w500,
                                                                  fontSize: 12.sp,
                                                                  color: AppColors.appBlackColor50, // Set the color for the border when not focused
                                                                ),),
                                                            )
                                                                : const SizedBox
                                                                .shrink()),
                                                    ...
                                                    InkWell(
                                                      onTap: (){
                                                        Navigator.pop(context);
                                                        Get.find<PayoutHistoryController>().payoutHistorySearchItems.clear();
                                                        Get.find<PayoutHistoryController>().getPayoutHistorySearchData(
                                                            Get.find<PayoutHistoryController>().name.text.toString(),
                                                            Get.find<PayoutHistoryController>().selectedDate.value,
                ...
                ListView(
                  ...
                  controller: Get.find<PayoutHistoryController>().scrollController,
                  shrinkWrap: true,
                  children: [
                        ...
                        if (payoutHistoryController.isLoading==true &&
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              if (index < payoutHistoryController.payoutHistorySearchItems.length) {
  ...
  List<DropdownMenuItem<String>> _buildDropdownItems() {
    return ['All Payment', 'Complete Payment', 'Pending Payment', 'Cancel Payment'].map((option) {
