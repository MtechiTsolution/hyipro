...
import 'package:hyip_pro/view/widgets/app_card_formatter.dart';
import 'package:hyip_pro/view/widgets/app_card_month_formatter.dart';
import 'package:hyip_pro/view/widgets/app_card_utils.dart';
...
class SecurioPayAuthorizenetPayScreen extends StatefulWidget {
  ...
  @override
  State<SecurioPayAuthorizenetPayScreen> createState() => _SecurioPayAuthorizenetPayScreenState();
}

class _SecurioPayAuthorizenetPayScreenState extends State<SecurioPayAuthorizenetPayScreen> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          ...
          "Pay with SecurionPay":"Pay with AuthorizeNet",style: TextStyle(
            fontSize: 16.sp,
            color: AppColors.getTextDarkLight()
        ),),
      ),
                    ...
                    children: [
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          filled: true,
                          hintStyle: const TextStyle( color: AppColors.appBlackColor50,),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                  suffixIcon: const Icon(Icons.date_range, color: AppColors.appBlackColor50,),
                                  contentPadding: const EdgeInsets.only(left: 12,
                                      top: 10,bottom: 12),
                                  border: OutlineInputBorder(
                                    borderRadius: BorderRadius.circular(8.0), // Set the border radius here
              ...
              Obx(() =>   Align(
                ...
                child: Padding(
                  ...
                  child: MaterialButton(
                    ...
                    child: Get.find<SecurionPayAuthorizenetController>().isLoading.value==false?
                    const Text("Submit",style: TextStyle(color: AppColors.appWhiteColor,fontSize: 16),):const CircularProgressIndicator(
                      color: AppColors.appWhiteColor,
                    ),
                    onPressed: () {

                      if (_formKey.currentState!.validate()) {
                        Get.find<SecurionPayAuthorizenetController>().cardPaymentRequest(
                            Get.find<DepositController>().amountController.text.toString(),
                            selectedOption.id,
