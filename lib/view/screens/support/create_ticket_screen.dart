                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                              ...
                              filled: true,
                              hintText: "${selectedLanguageStorage.read("languageData")["Enter Subject"]??"Enter Subject"}",
                              hintStyle: TextStyle(
                        ...
                        Padding(
                          ...
                          child: Text("${selectedLanguageStorage.read("languageData")["Message"]??"Message"}",style: TextStyle(
                              fontSize: 14.sp,
                          ),),
                        ),
                        SizedBox(height: 8.h,),
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                              ...
                              fillColor: AppColors.getTextFieldDarkLight(),
                              filled: true,
                              hintText: "${selectedLanguageStorage.read("languageData")["Enter Message"]??"Enter Message"}",
                              hintStyle: TextStyle(
                                  fontSize: 14.sp, fontWeight: FontWeight.w400)),
                        ),
                      ...
                      child: Row(
                        children: [
                          ...
                          _fileNames.isNotEmpty?
                            Text("${_fileNames.length} File Selected", style: TextStyle(
                        ...
                        GestureDetector(
                          onTap: (){
                            if (kDebugMode) {
                              print(createTicketController.subject.text.toString());
                            }
                            if (kDebugMode) {
                              print(createTicketController.message.text.toString());
                            }
                            if (kDebugMode) {
                          ...
                          child: Center(
                            child: Container(
                              ...
                              child: Center(
                                  child: createTicketController.isLoading==false ? Text(
