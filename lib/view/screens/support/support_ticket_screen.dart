          ...
          label: Row(
            children: [
              Padding(
                ...
                child: Icon(Icons.add,color: AppColors.appWhiteColor,size: 20.h,),
              ),
              Text(
          ...
          children: [
            ...
            GetBuilder<TicketListController>(
              builder: (ticketListController) {
                final historyItems =
                    ticketListController.ticketListItems;
                            ...
                            child: Container(
                              ...
                              BoxDecoration(
                                image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image: AssetImage("assets/images/ticket_list_bg.png")
                                )
                              ),
                              child: Stack(
                                children: [
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Image.asset("${checkStatusImage(item.status)}",
                                            height: 28.h,
                                              width: 28.w,
                                            ),
                                          ),
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            SizedBox(
                                              ...
                                              child: Text(truncateText(item.subject, 20),
                                            ...
                                            Row(
                                              children: [
                                                Text("${selectedLanguageStorage.read("languageData")["Last reply"]??"Last reply"} ",style: GoogleFonts.niramit(
                                                    fontWeight: FontWeight.w400,
                                                    fontSize: 16.sp,
                                                    color: AppColors.appBlackColor50
                                                ),),
                                                Text("${item.lastReply}",style: GoogleFonts.niramit(
                                                    fontWeight: FontWeight.w500,
                                                    fontSize: 16.sp,
                                                    color: AppColors.getTextDarkLight()
                                                ),),
