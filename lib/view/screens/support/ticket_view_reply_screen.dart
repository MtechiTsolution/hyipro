      ...
      try {
        ...
        if (result != null) {
          setState(() {
            ...
            selectedFilePaths.addAll(result!.paths.whereType<String>()); // Add selected paths to the list
          });
        }
        ...
        return RefreshIndicator(
          ...
          child: Scaffold(
            appBar: AppBar(
              ...
              elevation: 1,
              title:
              viewTicketController.isLoading==false && viewTicketController.message!=null?
              Text(
                ...
                GestureDetector(
                  onTap: (){
                    Get.defaultDialog(
                      ...
                      title: "${selectedLanguageStorage.read("languageData")["Alert!"] ?? "Alert!"}",
                      content: Column(
                        children: [
                          Container(
                            height: 1.h,
                      ...
                      actions: [
                        ...
                        ElevatedButton(
                          onPressed: () async {
                            Get.find<ReplyTicketController>().ticketReplyRequest(
                              context,
            ...
            body: GetBuilder<ViewTicketController>(
              builder: (viewTicketController) {
                return
                  viewTicketController.isLoading==false && viewTicketController.message!=null?
                  Stack(
                  children: [
                    Positioned.fill(
                      ...
                      Image.asset( // Set your background image asset here
                        ...
                        Expanded(
                          child: Container(
                            ...
                            decoration: const BoxDecoration(
                              color: Color(0x80F0F8FF), // Semi-transparent WhatsApp-like chat background color
                            ),
                            child:
                            ...
                            ListView.builder(
                              shrinkWrap: true,
                              reverse: true, // To make the chat messages scroll from bottom to top
                              itemCount: viewTicketController.message!.messages!.length,
                              itemBuilder: (BuildContext context, int index) {
                                return ListTile(
                                  title: Align(
                                    alignment: viewTicketController.message!.messages![index].adminId == null ? Alignment.centerRight : Alignment.centerLeft,
                                    child: Column(
                                      crossAxisAlignment: viewTicketController.message!.messages![index].adminId == null ? CrossAxisAlignment.end : CrossAxisAlignment.start,
                                      children: [
                                        GestureDetector(
                                          onTap: (){
                                            setState(() {
                                          ...
                                          child: viewTicketController.message!.messages![index].attachments == null ?
                                          Container(
                                            width: 200.w,
                                            padding: const EdgeInsets.all(8.0),
                                            decoration: BoxDecoration(
                                              color: viewTicketController.message!.messages![index].adminId == null ? AppColors.appPrimaryColor : Colors.white, // User and admin message bubble color
                                              borderRadius: BorderRadius.circular(10.0),
                                            ),
                                            child: SelectableText(
                                              viewTicketController.message!.messages![index].message.toString(),
                                              style: TextStyle(
                                                color: viewTicketController.message!.messages![index].adminId == null ? Colors.white : Colors.black, // User and admin message text color
                                              ),
                                            ),
                                          ) :
                                          Column(
                                            ...
                                            children: [
                                              Container(
                                                padding: const EdgeInsets.all(8.0),
                                                decoration: BoxDecoration(
                                                  color: viewTicketController.message!.messages![index].adminId == null ? AppColors.appBrandColor3 : AppColors.appBg1, // User and admin message bubble color
                                                  borderRadius: BorderRadius.circular(10.0),
                                                ),
                                                child: SelectableText(
                                                  viewTicketController.message!.messages![index].message.toString(),
                                                  style: TextStyle(
                                                    color: viewTicketController.message!.messages![index].adminId == null ? Colors.black : Colors.black, // User and admin message text color
                                                  ),
                                                ),
                                              ),
                                              Container(
                                                ...
                                                child: SingleChildScrollView(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: viewTicketController.message!.messages![index].attachments!
                                                      ...
                                                      return Padding(
                                                        ...
                                                        child: GestureDetector(
                                                          ...
                                                          child: Container(
                                                            decoration: BoxDecoration(
                                                              color: Get.isDarkMode? AppColors.appBlackColor: AppColors.appWhiteColor,
                                                              border: Border.all(
                        ...
                        Align(
                            ...
                            child: Container(
                              ...
                              width: double.infinity,
                                ...
                                child: Text("${_fileNames.length} File Selected",style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 14.sp,
                                  fontWeight: FontWeight.w500
                                ),)))
                                    ...
                                    onPressed: () {
                                      ...
                                      if(_textController.text.isNotEmpty){
                                        if(_fileNames.isEmpty){
                                          replyTicketController.ticketReplyRequest(
                                            context,
                                            viewTicketController.message!.id.toString(),
                                            ...
                                            viewTicketController.getViewTicketData(ticketId);
                                          });
                                        }
                                        else{
                                          replyTicketController.ticketReplyRequest(
