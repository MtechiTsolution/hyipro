...
import 'package:hyip_pro/data/model/response_model/two_fa_security_model.dart';
...
class TwoFaSecurityController extends GetxController{
    ...
    if (apiResponse.response != null && apiResponse.response!.statusCode == 200) {
      ...
      if (apiResponse.response!.data != null) {
        ...
        if(apiResponse.response!.data["message"]=="Email Verification Required"){
          ...
          twoFactorSecurityModel = TwoFactorSecurityModel.fromJson(apiResponse.response!.data!);
  ...
  Future<dynamic> enableTwoFactorSecurity(dynamic code, dynamic key,) async {
    _isLoading = true;
    update();
    ApiResponse apiResponse = await twoFaSecurityRepo.enableTwoFactorSecurity(code, key);
  ...
  Future<dynamic> disableTwoFactorSecurity(dynamic code) async {
    _isLoading = true;
    update();
    ApiResponse apiResponse = await twoFaSecurityRepo.disableTwoFactorSecurity(code);
