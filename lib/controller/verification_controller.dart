...
class VerificationController extends GetxController{
  ...
  Future<dynamic> sendAddressVerificationRequest(
      dynamic addressImagePath
      ) async {
    _isLoading = true;
    update();
    ApiResponse apiResponse = await verificationRepo.sendAddressVerificationRequest(addressImagePath);
  ...
  Future<dynamic> sendIdentityVerificationRequest(
    ...
    update();
    ApiResponse apiResponse = await verificationRepo.identityVerificationRequest(identityType, fieldNames, fieldValues);
