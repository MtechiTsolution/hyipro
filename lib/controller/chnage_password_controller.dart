...
class ChangePasswordController extends GetxController{
  ...
  Future<dynamic> changePasswordRequest(dynamic currentPassword, dynamic password, dynamic passwordConfirm,) async {
    _isLoading = true;
    update();

    ApiResponse apiResponse = await changePasswordRepo.changePasswordRequest(currentPassword,password,passwordConfirm);
      ...
      if (apiResponse.response!.data != null) {
        if(apiResponse.response!.data["message"]=="Email Verification Required"){
          ...
          Get.snackbar(
            'Message',
            '${msg}',
            backgroundColor: status == "success" ? AppColors.appGreen50 : Colors.red,
