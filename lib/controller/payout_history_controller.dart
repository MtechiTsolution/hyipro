...
import 'package:hyip_pro/data/model/response_model/payout_history_search_model.dart';
...
class PayoutHistoryController extends GetxController{
  ...
  PayoutHistorySearchModel payoutHistorySearchModel = PayoutHistorySearchModel();
  ...
  Future<dynamic> getPayoutHistorySearchData(
    ...
    update();
    ApiResponse apiResponse = await payoutHistoryRepo.searchRequestPayoutHistory(name,createdAt,status,page: page);
