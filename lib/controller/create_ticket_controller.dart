...
class CreateTicketController extends GetxController{
  ...
  Future<dynamic> createTicketRequest(
      dynamic subject, dynamic message,dynamic result,BuildContext context
      ) async {
    _isLoading = true;
    update();
    ApiResponse apiResponse = await createTicketRepo.createTicketRequest(subject, message,result);
