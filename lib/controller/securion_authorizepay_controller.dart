...
class SecurionPayAuthorizenetController extends GetxController{
  ...
  SecurionPayAuthorizenetController({required this.securionPayAuthorizenetRepo});
  ...
  Future<dynamic> cardPaymentRequest(
    ...
    update();
    ApiResponse apiResponse = await securionPayAuthorizenetRepo.cardPaymentRequest(amount, gateway, cardNumber, cardName, expiryMonth, expiryYear, cardCVC);
