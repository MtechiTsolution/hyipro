...
import 'package:hyip_pro/data/model/response_model/invest_history_model.dart';
...
class InvestHistoryController extends GetxController {
  ...
  Future<void> getInvestHistoryData(dynamic page) async {
    ...
    update();
    try {
      ApiResponse apiResponse = await investHistoryRepo.getInvestHistoryData(page);
      ...
      if (apiResponse.response != null && apiResponse.response!.statusCode == 200) {
        ...
        if (apiResponse.response!.data != null) {
          ...
          if(apiResponse.response!.data["message"]=="Email Verification Required"){
            ...
            investHistoryModel = InvestHistoryModel.fromJson(apiResponse.response!.data!);
