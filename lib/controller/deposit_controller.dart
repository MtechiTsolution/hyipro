...
import 'package:hyip_pro/data/model/response_model/payment_method_model.dart';
...
class DepositController extends GetxController {
  ...
  PaymentGatewayData? get message => _message;
                    ...
                    for (var gateway in _gateways!) {
                      ...
                      if (gateway.code == "stripe") {
                        ...
                        if (kDebugMode) {
                          ...
                          print('Stripe Publishable Key: $stripePublisherKey');
                        }
                      }
                      ...
                      if (gateway.code == "razorpay") {
                        ...
                        if (kDebugMode) {
                          print('RazorPay Key ID: $keyIdRazorPay');
                          print('RazorPay Secret: $keySecretRazorPay');
                        }
                      }
                      ...
                      if (gateway.code == "paytm") {
                        ...
                        if (kDebugMode) {
                          ...
                          print('Paytm secret: $merchantKeyPaytm');
                        }
                      }
                      ...
                      if (gateway.code == "flutterwave") {
                        ...
                        if (kDebugMode) {
                          ...
                          print('FlutterWave secretKey: $secretKeyFlutterWave');
                        }
                      }
                      ...
                      if (gateway.code == "paypal") {
                        ...
                        if (kDebugMode) {
                          print('Paypal clientId: $clientIdPaypal');
                          print('Paypal secret: $secretKeyPaypal');
                        }
                      }
                      ...
                      if (gateway.code == "paystack") {
                        ...
                        if (kDebugMode) {
                          print('PayStack publicKey: $publicKeyPayStack');
                          print('Paypal secret: $secretKeyPayStack');
                        }
                      }
