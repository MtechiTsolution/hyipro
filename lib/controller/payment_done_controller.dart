...
class PaymentDoneController extends GetxController {
  ...
  Future<dynamic> paymentDoneRequest(dynamic gateway,
      dynamic amount,
      dynamic planId,) async {
    _isLoading = true;
    update();
    ApiResponse apiResponse = await paymentDoneRepo.paymentDoneRequest(
        gateway, amount, planId);
