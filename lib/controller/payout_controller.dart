...
import 'package:hyip_pro/data/model/response_model/payout_model.dart';
import 'package:hyip_pro/data/model/response_model/paystack_bank_data_model.dart';
      ...
      if (apiResponse.response!.data != null) {
        ...
        if (apiResponse.response!.data["message"] ==
          ...
          if (kDebugMode) {
            ...
            print(supportedCurrencyFlutterWave);
          }
