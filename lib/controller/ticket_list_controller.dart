...
import 'package:hyip_pro/data/model/response_model/ticket_list_model.dart';
...
class TicketListController extends GetxController{
  ...
  /// Get Ticket Data
  Future<dynamic> getTicketListData(dynamic page,) async {
    _isLoading = true;
    if(page==1){
      ticketListItems=[];
    }
    ...
    if (apiResponse.response != null && apiResponse.response!.statusCode == 200) {
      ...
      if (apiResponse.response!.data != null) {
        ...
        if(apiResponse.response!.data["message"]=="Email Verification Required"){
          ...
          ticketListModel = TicketListModel.fromJson(apiResponse.response!.data!);
