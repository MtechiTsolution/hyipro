...
class VerifyRequiredController extends GetxController{
  ...
  bool get isLoadingSms => _isLoadingSms;
   ...
   twoFactorVerifySubmit(dynamic code) async {
    ...
    update();
    ApiResponse apiResponse = await verifyRequiredRepo.twoFactorSubmitRepo(code);
   ...
   mailVerifySubmit(dynamic code) async {
     _isLoadingMail = true;
    update();
    ApiResponse apiResponse = await verifyRequiredRepo.mailVerifySubmitRepo(code);
   ...
   smsVerifySubmit(dynamic code) async {
     _isLoadingSms = true;
    update();
    ApiResponse apiResponse = await verifyRequiredRepo.smsVerifySubmitRepo(code);
