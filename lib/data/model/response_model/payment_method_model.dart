...
class PaymentGatewayData {
  ...
  factory PaymentGatewayData.fromJson(Map<String, dynamic> json) => PaymentGatewayData(
    ...
    gateways: json["gateways"] == null ? null : List<Gateway>.from(json["gateways"].map((x) => Gateway.fromJson(x))),
  );
...
class Gateway {
  ...
  dynamic currency;
  dynamic symbol;
  Map<String, dynamic>? parameters; // Store dynamic parameters as a map
