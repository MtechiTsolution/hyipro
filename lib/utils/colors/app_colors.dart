...
class AppColors{
  ...
  static const appFillColor = Color(0xffe5ccb0);
 ...
 // static const appBrandDeep = Color(0xff93C3C0);
  static const appBrandDeep = Color(0xffa8732b);
  ...
  static const appDashBoardTransactionPending = Color(0xffa8732b);
...
//  static Color appTicketOpenColor = Color(0xff93C3C0).withOpacity(0.1);
  static Color appTicketOpenColor = Color(0xffa8732b).withOpacity(0.1);
//  static Color appTicketReplyColor = Color(0xff93C3C0).withOpacity(0.1);
  static Color appTicketReplyColor = Color(0xffa8732b).withOpacity(0.1);
  ...
  static Color appPrimaryColor = Color(0xffa8732b);
  static Color appMainBalanceIconColor = Color(0xffa8732b);
  static Color appTotalDepositIconColor = Color(0xffa8732b);
  static Color appTotalEarnIconColor = Color(0xffa8732b);
  // static Color appTotalEarnIconColor = Color(0xff8971AD);
  static Color appTotalInvestIconColor = Color(0xff749BCD);
  static Color appTotalPayoutIconColor = Color(0x60ffffff);
